...
class GroceryRVAdapter(
    ...
    val groceryItemClickInterface: GroceryRVAdapter.GroceryItemClickInterface
    ...
    override fun onBindViewHolder(holder: GroceryViewHolder, position: Int) {
       ...
       holder.quantityTV.text = list.get(position).itemQuatity.toString()
       holder.rateTV.text = list.get(position).itemPrice.toString()
       val itemTotal: Int = list.get(position).itemPrice * list.get(position).itemQuatity
